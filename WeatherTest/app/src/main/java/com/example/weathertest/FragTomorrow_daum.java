...
public class FragTomorrow_daum extends Fragment {
    private View view;
    ...
    String address;
    public static FragTomorrow_daum newInstance(String address){
        FragTomorrow_daum fragTomorrow = new FragTomorrow_daum(address);
        return fragTomorrow;
    }
    FragTomorrow_daum(String address){
