...
public class FragTomorrow_naver extends Fragment {
    ...
    String address;
    public static FragTomorrow_naver newInstance(String address){
        FragTomorrow_naver fragTomorrow = new FragTomorrow_naver(address);
        return fragTomorrow;
    }

    FragTomorrow_naver(String address){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Handler handler = new Handler(Looper.myLooper()) {
            ...
            public void handleMessage(@NonNull Message msg) {
                ...
                tv_weather_morning.setText(tomorrowaver[1]);
                tv_temp_after.setText(tomorrowaver[2]);
                tv_weather_after.setText(tomorrowaver[3]);
                switch (tomorrowaver[1]) { //오전 날씨
                    case "맑음":
                    ...
                    case "구름많음":
                        ...
                        break;
                    case "안개":
                        iv_weather_morning.setImageResource(R.drawable.fog);
                        break;
                }
                if(tomorrowaver[1].contains("비") && tomorrowaver[1].contains("눈")) //비 또는 눈일때
                    iv_weather_morning.setImageResource(R.drawable.rainy_or_snowy);
                else if(tomorrowaver[1].contains("비"))
                    iv_weather_morning.setImageResource(R.drawable.rainy);
                else if(tomorrowaver[1].contains("눈"))
                    iv_weather_morning.setImageResource(R.drawable.snowy);

                switch (tomorrowaver[3]) { //오후 날씨
                    case "맑음":
                        iv_weather_after.setImageResource(R.drawable.sun);break;
                    case "흐림":
                        iv_weather_after.setImageResource(R.drawable.cloudy);
                        break;
                    case "구름조금":
                    ...
                    case "안개":
                        iv_weather_after.setImageResource(R.drawable.fog);
                        break;
                }
                if(tomorrowaver[3].contains("비") && tomorrowaver[3].contains("눈")) //비 또는 눈일때
                    iv_weather_after.setImageResource(R.drawable.rainy_or_snowy);
                else if(tomorrowaver[3].contains("비"))
                    iv_weather_after.setImageResource(R.drawable.rainy);
                else if(tomorrowaver[3].contains("눈"))
                    iv_weather_after.setImageResource(R.drawable.snowy);
                ...
                switch (weather[2]) {
                    case "맑음":
                        ...
                        break;
                    case "흐림":
                        iv_weather_tomorrow1.setImageResource(R.drawable.cloudy);
                        break;
                    case "구름조금":
                        if (n >= 6 && n<18)
                    ...
                    case "구름많음":
                        ...
                        break;
                    case "안개":
                        iv_weather_tomorrow1.setImageResource(R.drawable.fog);
                        break;
                }
                if(weather[2].contains("비") && weather[2].contains("눈")) //비 또는 눈일때
                    ...
                    iv_weather_tomorrow1.setImageResource(R.drawable.rainy);
                else if(weather[2].contains("눈"))
                    iv_weather_tomorrow1.setImageResource(R.drawable.snowy);
                ...
                switch (weather[3]) {
                    case "맑음":
                        ...
                        break;
                    case "흐림":
                        iv_weather_tomorrow2.setImageResource(R.drawable.cloudy);
                        break;
                    case "구름조금":
                        if (n >= 6 && n<18)
                    ...
                    case "구름많음":
                        ...
                        break;
                    case "안개":
                        iv_weather_tomorrow2.setImageResource(R.drawable.fog);
                        break;
                }
                if(weather[3].contains("비") && weather[3].contains("눈")) //비 또는 눈일때
                    ...
                    iv_weather_tomorrow2.setImageResource(R.drawable.rainy);
                else if(weather[3].contains("눈"))
                    iv_weather_tomorrow2.setImageResource(R.drawable.snowy);
                ...
                switch (weather[4]) {
                    case "맑음":
                        ...
                        break;
                    case "흐림":
                        iv_weather_tomorrow3.setImageResource(R.drawable.cloudy);
                        break;
                    case "구름조금":
                        if (n >= 6 && n<18)
                    ...
                    case "구름많음":
                        ...
                        break;
                    case "안개":
                        iv_weather_tomorrow3.setImageResource(R.drawable.fog);
                        break;
                }
                if(weather[4].contains("비") && weather[4].contains("눈")) //비 또는 눈일때
                    ...
                    iv_weather_tomorrow3.setImageResource(R.drawable.rainy);
                else if(weather[4].contains("눈"))
                    iv_weather_tomorrow3.setImageResource(R.drawable.snowy);
                ...
                switch (weather[5]) {
                    case "맑음":
                        ...
                        break;
                    case "흐림":
                        iv_weather_tomorrow4.setImageResource(R.drawable.cloudy);
                        break;
                    case "구름조금":
                        if (n >= 6 && n<18)
                    ...
                    case "구름많음":
                        ...
                        break;
                    case "안개":
                        iv_weather_tomorrow4.setImageResource(R.drawable.fog);
                        break;
                }
                if(weather[5].contains("비") && weather[5].contains("눈")) //비 또는 눈일때
                    ...
                    iv_weather_tomorrow4.setImageResource(R.drawable.rainy);
                else if(weather[5].contains("눈"))
                    iv_weather_tomorrow4.setImageResource(R.drawable.snowy);
                ...
                switch (weather[6]) {
                    case "맑음":
                        ...
                        break;
                    case "흐림":
                        iv_weather_tomorrow5.setImageResource(R.drawable.cloudy);
                        break;
                    case "구름조금":
                        if (n >= 6 && n<18)
                    ...
                    case "구름많음":
                        ...
                        break;
                    case "안개":
                        iv_weather_tomorrow5.setImageResource(R.drawable.fog);
                        break;
                }
                if(weather[6].contains("비") && weather[6].contains("눈")) //비 또는 눈일때
                    ...
                    iv_weather_tomorrow5.setImageResource(R.drawable.rainy);
                else if(weather[6].contains("눈"))
                    iv_weather_tomorrow5.setImageResource(R.drawable.snowy);
            }
        };
