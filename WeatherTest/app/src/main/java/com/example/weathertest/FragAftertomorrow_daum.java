...
public class FragAftertomorrow_daum extends Fragment {
    private View view;
    ...
    public static FragAftertomorrow_daum newInstance(String address){
        FragAftertomorrow_daum fragAfterto = new FragAftertomorrow_daum(address);
        return fragAfterto;
    }
    FragAftertomorrow_daum(String address){
